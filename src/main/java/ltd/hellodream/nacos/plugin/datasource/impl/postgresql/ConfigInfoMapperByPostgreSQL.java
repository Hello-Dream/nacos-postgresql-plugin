...
/**
 * The PostgreSQL implementation of {@link ConfigInfoMapper}.
 *
 * @author HelloDream
 **/
...
public class ConfigInfoMapperByPostgreSQL extends AbstractMapper implements ConfigInfoMapper {
    ...
    public MapperResult findAllConfigInfoBaseFetchRows(MapperContext context) {
        String sql = "SELECT t.id,data_id,group_id,content,md5"
                + " FROM ( SELECT id FROM config_info ORDER BY id LIMIT " + context.getPageSize() + " offset " + context.getStartRow() + "  ) "
